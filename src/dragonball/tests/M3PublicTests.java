...
public class M3PublicTests {
	...
	assertTrue("Game Class should have \"load\" method", containsMethodName(methods, "load"));
	Method m;
	try {
	    m = Game.class.getDeclaredMethod("load", String.class);
	    assertTrue("incorrect return type for \"load\" method in Game Class.", m.getReturnType().equals(Void.TYPE));
	}
	catch (Exception e) {
	...
	assertEquals("InvalidFormatException class should extend predefined IOException", IOException.class,
		InvalidFormatException.class.getSuperclass());
    }

    @Test(timeout = 1000)
    public void testInvalidFormatExceptionIsAbstract() throws Exception {
	assertTrue("InvalidFormatException class should be an abstract class",
	...
	assertFalse("there should be \"sourceFile\" instance variable in class InvalidFormatException", thrown);
	assertEquals("\"sourceFile\" instance variable in class InvalidFormatException should be of type String",
	...
	assertFalse("there should be \"sourceLine\" instance variable in class InvalidFormatException", thrown);
	assertEquals("\"sourceLine\" instance variable in class InvalidFormatException should be of type int",
		f.getType(), int.class);
    }

    @Test(timeout = 1000)
    public void testInvalidFormatExceptionClassVariablesAccessibility() throws Exception {
	...
	assertTrue("The \"sourceFile\" instance variable in class InvalidFormatException is a READ variable.",
		containsMethodName(methods, "getSourceFile"));

	assertTrue("The \"sourceLine\" instance variable in class InvalidFormatException is a READ variable.",
		containsMethodName(methods, "getSourceLine"));

	try {
	    Method m = InvalidFormatException.class.getDeclaredMethod("getSourceFile");
	    assertTrue("incorrect return type for \"getSourceFile\" method in InvalidFormatException class.",
	...
	try {
	    Method m = InvalidFormatException.class.getDeclaredMethod("getSourceLine");
	    assertTrue("incorrect return type for \"getSourceLine\" method in InvalidFormatException class.",
	...
	assertFalse("The \"sourceFile\" instance variable in class InvalidFormatException is a READ ONLY variable.",
		containsMethodName(methods, "setSourceFile"));

	assertFalse("The \"sourceLine\" instance variable in class InvalidFormatException is a READ ONLY variable.",
	...
	assertFalse("Missing constructor with 2 parameters in InvalidFormatException class.", thrown);
    }
	...
	boolean thrown = false;
	try {
	    aClass.getConstructor(new Class[] { String.class, String.class, int.class });
	}
	catch (NoSuchMethodException e) {
	    thrown = true;
	}
	assertFalse("Missing constructor with 3 parameters in InvalidFormatException class.", thrown);
    }

    @Test(timeout = 1000)
    public void testMissingFieldExceptionExtendsInvalidFormatException() throws Exception {
	assertEquals("MissingFieldException class should extend predefined InvalidFormatException",
		InvalidFormatException.class, MissingFieldException.class.getSuperclass());
    }
	...
	assertFalse("there should be \"missingFields\" instance variable in class MissingFieldException", thrown);
	assertEquals("\"missingFields\" instance variable in class MissingFieldException should be of type int",
		f.getType(), int.class);
    }

    @Test(timeout = 1000)
    public void testMissingFieldExceptionClassVariablesAccessibility() throws Exception {
	...
	assertTrue("The \"missingFields\" instance variable in class MissingFieldException is a READ variable.",
		containsMethodName(methods, "getMissingFields"));

	try {
	    Method m = MissingFieldException.class.getDeclaredMethod("getMissingFields");
	    assertTrue("incorrect return type for \"getMissingFields\" method in MissingFieldException class.",
		    m.getReturnType().equals(int.class));
	}
	catch (Exception e) {
	...
	assertFalse("The \"missingFields\" instance variable in class MissingFieldException is a READ ONLY variable.",
	...
	boolean thrown = false;
	try {
	    aClass.getConstructor(new Class[] { String.class, int.class, int.class });
	}
	catch (NoSuchMethodException e) {
	    thrown = true;
	}
	assertFalse("Missing constructor with 3 parameters in MissingFieldException class.", thrown);
    }
	...
	boolean thrown = false;
	try {
	    aClass.getConstructor(new Class[] { String.class, String.class, int.class, int.class });
	}
	catch (NoSuchMethodException e) {
	    thrown = true;
	}
	assertFalse("Missing constructor with 4 parameters in MissingFieldException class.", thrown);
    }

    @Test(timeout = 1000)
    public void testMissingFieldFirstConstructorInitialization() throws Exception {
    ...
    @Test(timeout = 1000)
    public void testMissingFieldSecondConstructorInitialization() throws Exception {

	MissingFieldException e = new MissingFieldException("Message", "sourceFile", 1, 2);
	...
	assertEquals("DragonBallException class should extend Exception", Exception.class,
		DragonBallException.class.getSuperclass());
    }

    @Test(timeout = 1000)
    public void testDragonBallExceptionIsAbstract() throws Exception {
	assertTrue("DragonBallException class should be an abstract class",
		Modifier.isAbstract(InvalidFormatException.class.getModifiers()));
    }
	...
	assertFalse("Missing constructor with no parameters in DragonBallException class.", thrown);
    }
	...
	assertFalse("Missing constructor with 1 parameter in DragonBallException class.", thrown);
    }

    @Test(timeout = 1000)
    public void testNotEnoughSenzuBeansExtendsNotEnoughResources() throws Exception {
	assertEquals("NotEnoughSenzuBeansException class should extend NotEnoughResourcesException",
		NotEnoughResourcesException.class, NotEnoughSenzuBeansException.class.getSuperclass());
    }
	...
	assertFalse("Missing constructor with no parameters in NotEnoughSenzuBeansException class.", thrown);
    }

    @Test(timeout = 1000)
    public void testNotEnoughKiExceptionExtendsNotEnoughResourcesException() throws Exception {
	assertEquals("NotEnoughKiException class should extend predefined NotEnoughResourcesException",
		NotEnoughResourcesException.class, NotEnoughKiException.class.getSuperclass());
    }
	...
	assertFalse("there should be \"availableKi\" instance variable in class NotEnoughKiException", thrown);
	assertEquals("\"availableKi\" instance variable in class NotEnoughKiException should be of type int",
		f.getType(), int.class);
	thrown = false;
	try {
	...
	assertFalse("there should be \"requiredKi\" instance variable in class NotEnoughKiException", thrown);
	assertEquals("\"requiredKi\" instance variable in class NotEnoughKiException should be of type int",
		f.getType(), int.class);
    }

    @Test(timeout = 1000)
    public void testNotEnoughKiExceptionClassVariablesAccessibility() throws Exception {
	...
	assertTrue("The \"availableKi\" instance variable in class NotEnoughKiException is a READ variable.",
		containsMethodName(methods, "getAvailableKi"));
	assertTrue("The \"requiredKi\" instance variable in class NotEnoughKiException is a READ variable.",
		containsMethodName(methods, "getRequiredKi"));

	try {
	    Method m = NotEnoughKiException.class.getDeclaredMethod("getRequiredKi");
	    assertTrue("incorrect return type for \"getRequiredKi\" method in NotEnoughKiException class.",
		    m.getReturnType().equals(int.class));
	}
	catch (Exception e) {
	...
	assertFalse("The \"availableKi\" instance variable in class NotEnoughKiException is a READ ONLY variable.",
		containsMethodName(methods, "setAvailableKi"));
	assertFalse("The \"requiredKi\" instance variable in class NotEnoughKiException is a READ ONLY variable.",
	...
	boolean thrown = false;
	try {
	    aClass.getConstructor(new Class[] { int.class, int.class });
	}
	catch (NoSuchMethodException e) {
	    thrown = true;
	}
	assertFalse("Missing constructor with 2 parameters in NotEnoughKiException class.", thrown);
    }
    ...
    @Test(timeout = 1000)
    public void testNotASaiyanExceptionExtendsInvalidAssignAttackException() throws Exception {
	assertEquals("NotASaiyanException class should extend InvalidAssignAttackException",
		InvalidAssignAttackException.class, NotASaiyanException.class.getSuperclass());
    }
	...
	assertFalse("Missing constructor with no parameters in NotASaiyanException class.", thrown);
    }

    @Test(timeout = 1000)
    public void testMaximumAttacksLearnedExtendsNotEnoughResources() throws Exception {
	assertEquals("MaximumAttacksLearnedException class should extend InvalidAssignAttackException",
		InvalidAssignAttackException.class, MaximumAttacksLearnedException.class.getSuperclass());
    }

    @Test(timeout = 1000)
    public void testMaximumAttacksLearnedExceptionConstructor() throws Exception {
	...
	assertFalse("Missing constructor with no parameters in MaximumAttacksLearnedException class.", thrown);
    }
	...
	try {
	    ...
	    assertTrue(
		    ...
		    e.getMessage().contains("0") && e.getMessage().contains("8"));
	    return;
	}
	...
	try {
	    ...
	    assertTrue(
		    ...
		    e.getMessage().contains("3") && e.getMessage().contains("9"));
    ...
    public void testUltimateAssignAttackMethod_Throws_MaximumAttacksLearnedException()
	    throws Exception, MaximumAttacksLearnedException, DuplicateAttackException {
    ...
    @Test(timeout = 1000)
    public void testSuperAssignAttackMethod_Throws_DuplicateAttackException() throws Exception {
	...
	try {
	    ...
	    System.err.println("Attacks " + learned.equals(s1));
    ...
    @Test(timeout = 1000)
    public void testLoadAttacksMethod_Throws_MissingFieldException() throws Exception {
	try {
	    Game g = new Game();
	    g.getAttacks().clear();
	    ...
	    assertTrue(
		    ...
		    ((MissingFieldException) e.getCause()).getMessage().contains("AttacksTest.csv"));
	    assertTrue(
		    ...
		    ((MissingFieldException) e.getCause()).getMessage().contains("2"));
	    assertTrue(
		    ...
		    ((MissingFieldException) e.getCause()).getMessage().contains("1"));
	}
    ...
    @Test(timeout = 1000)
    public void testLoadFoesMethod_Throws_MissingFieldException() throws Exception {
	try {
	    Game g = new Game();
	    ...
	    System.err.println(((MissingFieldException) e.getCause()).getMessage());
	    assertTrue(
		    ...
		    ((MissingFieldException) e.getCause()).getMessage().contains("4"));
	    assertTrue(
    ...
    @Test(timeout = 1000)
    public void testGameConstructor_Handles_MissingFieldException_OnLoadDragons() throws Exception {
	thrown = 0;
	Game g = null;
	try {
	    g = new Game() {
	...
	assertEquals("Load Dragons should load from the auxiliary csv file when an exception is thrown", 1,
		testDragons.size());

	assertEquals("Dragon name is not loaded correctly from the auxiliary CSV file of Dragons", "Shenron",
		testDragons.get(0).getName());

	assertEquals("Dragon senzuBeans is not loaded correctly from the auxiliary CSV file of Dragons", 10,
		testDragons.get(0).getSenzuBeans());

	assertEquals("Dragon ability points is not loaded correctly from the auxiliary CSV file of Dragons", 5,
	...
	assertEquals("Super Attack of Dragon is not loaded correctly from the auxiliary CSV file of Dragons",
		"Big Bang Kamehameha", testDragons.get(0).getSuperAttacks().get(0).getName());
	assertEquals("Super Attack of Dragon is not loaded correctly from the auxiliary CSV file of Dragons",
		"Emperor's Death Beam", testDragons.get(0).getSuperAttacks().get(1).getName());
	...
	assertEquals("Ultimate Attack of Dragon is not loaded correctly from the auxiliary CSV file of Dragons",
		"Super Big Bang Kamehameha", testDragons.get(0).getUltimateAttacks().get(0).getName());
	assertEquals("Ultimate Attack of Dragon is not loaded correctly from the auxiliary CSV file of Dragons",
		"Final Shine Attack", testDragons.get(0).getUltimateAttacks().get(1).getName());
	assertEquals("Ultimate Attack of Dragon is not loaded correctly from the auxiliary CSV file of Dragons",
		"Final Galick Gun", testDragons.get(0).getUltimateAttacks().get(2).getName());
    }

    @Test(timeout = 1000)
    public void testGameConstructor_Handles_MissingFieldException_OnLoadAttacks() throws Exception {
	thrown = 0;
	Game g = null;
	try {
	    g = new Game() {
		public void loadAttacks(String f) throws MissingFieldException, UnknownAttackTypeException {
		    thrown++;
		    if (thrown++ == 1) {
			throw new MissingFieldException(f, 0, 2);
		    }
	...
	assertEquals("Load Attacks should load from the auxiliary csv file when an exception is thrown", 1,
		auxAttacks.size());

	assertTrue("Attack type is not loaded correctly from the auxiliary CSV file of Attacks",
		auxAttacks.get(0) instanceof MaximumCharge);
	assertEquals("Attack name is not loaded correctly from the auxiliary CSV file of Attacks", "Maximum Charge",
		auxAttacks.get(0).getName());
	assertEquals("Attack damage is not loaded correctly from the auxiliary CSV file of Attacks", 0,
		auxAttacks.get(0).getDamage());
    }
	...
	NonPlayableFighter foe = new NonPlayableFighter("fighter", 1, 1, 10, 1250, 50, 40, false, null, null);
	ArrayList<SuperAttack> superAttacks1 = new ArrayList<SuperAttack>();
	...
	assertFalse("NotEnoughKiException should not be thrown if the user tries to use a Maximum charge attack",
		thrown);
    }
	...
	assertFalse("NotEnoughKiException should not be thrown if the user tries to use a physical attack", thrown);
    }
	...
	boolean thrown = false;
	me.setKi(1);
	System.err.println("KI " + ((Fighter) b.getAttacker()).getKi());
	try {
	...
	try {
	    ...
	    assertEquals(
		    ...
		    1, e.getRequiredKi());
	    assertTrue("The thrown message of NotEnoughKiException should contain the requiredKi value",
		    e.getMessage().contains(e.getRequiredKi() + ""));
	    assertTrue("The thrown message of NotEnoughKiException should contain the availableKi value",
    ...
    public static void executeLoadAttacks_InCorrectFile_UnkownAttack(Object o, Class c)
	    throws UnknownAttackTypeException, IllegalAccessException, IllegalArgumentException,
	    InvocationTargetException, NoSuchMethodException, SecurityException, FileNotFoundException {
	Method method = c.getDeclaredMethod("loadAttacks", new Class[] { String.class });
    ...
    public static void executeLoadAttacks_CorrectFile_UnknownAttack(Object o, Class c)
	    throws UnknownAttackTypeException, IllegalAccessException, IllegalArgumentException,
	    InvocationTargetException, NoSuchMethodException, SecurityException, FileNotFoundException {
	Method method = c.getDeclaredMethod("loadAttacks", new Class[] { String.class });
	method.setAccessible(true);
    ...
    public static void executeLoadAttacks_InCorrectFile_MissingField(Object o, Class c)
	    throws UnknownAttackTypeException, IllegalAccessException, IllegalArgumentException,
	    InvocationTargetException, NoSuchMethodException, SecurityException, FileNotFoundException {
	Method method = c.getDeclaredMethod("loadAttacks", new Class[] { String.class });
	method.setAccessible(true);
    ...
    public static void executeLoadAttacks_CorrectFile_MissingField(Object o, Class c)
	    throws UnknownAttackTypeException, IllegalAccessException, IllegalArgumentException,
	    InvocationTargetException, NoSuchMethodException, SecurityException, FileNotFoundException {
	Method method = c.getDeclaredMethod("loadAttacks", new Class[] { String.class });
	method.setAccessible(true);
    ...
    public static void executeLoadFoes_InCorrectFile_MissingField(Object o, Class c) throws Exception {
	Method method = c.getDeclaredMethod("loadFoes", new Class[] { String.class });
	method.setAccessible(true);
    ...
    public static void executeLoadFoes_CorrectFile_MissingField(Object o, Class c) throws Exception {
	Method method = c.getDeclaredMethod("loadFoes", new Class[] { String.class });
	method.setAccessible(true);
	PrintWriter foesWriter = new PrintWriter("FoesTest.csv");
	foesWriter.println("Goku,10,3000,350,400,5,6,TRUE");
